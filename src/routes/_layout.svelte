...
<TopAppBar variant="static" class="main-top-app-bar">
  <Row>
    <Section>
      ...
      {/if}
      <Title component={A} href="/" class="mdc-theme--on-primary" style="{miniWindow ? 'padding-left: 0;' : ''}">
        Sound Rodeo
      </Title>
    </Section>
...
<div class="drawer-container">
  <Drawer variant={miniWindow ? 'modal' : null} bind:open={drawerOpen} class="main-drawer {miniWindow ? 'main-drawer-adjust' : ''}">
    <Content>
      <List>
